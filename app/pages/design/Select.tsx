...
const apiRows: ApiRow[] = [
  ...
  {
    prop: 'color',
    description: '沿用 Rue 现有 select-<tone> 颜色层',
  ...
  {
    prop: 'ghost',
    description: '兼容旧 API，等价于 variant="ghost" 的快捷写法',
    type: 'boolean',
    defaultValue: 'false',
  },
  {
  ...
  {
    prop: 'onDeselect',
    description: '多选取消或单选切换掉旧值时触发，返回被移除的值与 option 信息',
  ...
  {
    prop: 'variant',
    description: '选择器外观变体，补齐 filled / ghost / borderless 语义',
      ...
      <div className="max-w-none prose prose-sm md:prose-base">
        ...
        <div className="not-prose mt-8 space-y-2">
          ...
          <p className="text-sm text-base-content/70">
            先保留旧的 children 写法，再把数据驱动、分组和 shell 组合能力补进来。
          </p>
        </div>
        ...
        <div className="not-prose mt-10 space-y-2">
          ...
          <p className="text-sm text-base-content/70">
            新增 status、variant、紧凑多选、loading 与空态，覆盖更接近业务表单的实际需求。
          </p>
        </div>
            ...
            <div className="card border border-base-200/80 bg-base-100 shadow-sm">
              <div className="card-body grid gap-4 lg:grid-cols-[minmax(0,20rem),1fr] lg:items-start">
                ...
                <div className="mockup-code text-xs">
                  ...
                  <pre data-prefix="$">
                    <code>已选项会以内联标签展示，并保留下拉面板勾选态</code>
                  </pre>
                </div>
              </div>
            </div>
