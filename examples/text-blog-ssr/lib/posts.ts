...
export const posts: Post[] = [
  ...
  {
    slug: 'wasm-runtime-notes',
    title: 'Wasm runtime notes for UI examples',
    excerpt: 'What to keep visible when an example relies on a Rust and WebAssembly runtime layer.',
    body: [
      'Runtime demos should make the boundary between authored JSX and generated output easy to inspect.',
      'A small post can describe the runtime behavior without forcing readers into the implementation first.',
      'Clear examples also make regressions easier to spot when the Wasm package changes.',
    ],
    author: 'Xiang',
    topic: 'runtime',
    tags: ['Wasm', 'runtime', 'testing'],
    date: '2026-05-12',
    readMinutes: 5,
  },
  {
