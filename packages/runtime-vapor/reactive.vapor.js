...
installSharedBridge({
  SignalHandle: reactiveRuntime.SignalHandle,
  __rueActivateEffectOwnerTracking: reactiveRuntime.__rueActivateEffectOwnerTracking,
  __rueBeginRenderDebugOwner: reactiveRuntime.__rueBeginRenderDebugOwner,
  __rueCreateDetachedEffectScope: reactiveRuntime.__rueCreateDetachedEffectScope,
  __rueDisposeEffectScope,
  __rueDisposeHookScopeForInstance: reactiveRuntime.__rueDisposeHookScopeForInstance,
  __rueEndRenderDebugOwner: reactiveRuntime.__rueEndRenderDebugOwner,
  __ruePopEffectScope: reactiveRuntime.__ruePopEffectScope,
  __ruePushEffectScope: reactiveRuntime.__ruePushEffectScope,
  getCurrentInstance: reactiveRuntime.getCurrentInstance,
  propsReactive,
  setCurrentInstance: reactiveRuntime.setCurrentInstance,
})
