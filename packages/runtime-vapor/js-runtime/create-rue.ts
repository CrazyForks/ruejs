  ...
  const runtime: RueRuntime = {
    ...
    mount(app, container) {
      return appController.mount(app, container, root => {
        ...
        runRenderEntry(() => renderContainer(state, input, container))
