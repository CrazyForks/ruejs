...
export interface PortableMountHandle {
  __rue_mount_id: number
  key?: MountKey
}
...
export const DEFAULT_MOUNT_HANDLE_KEY = '__rue_mount_id'
export const PORTABLE_COMPONENT_TYPE_KEY = '__rue_component_type'
export const PORTABLE_COMPONENT_ID_KEY = '__rue_component_type_id'
export const PORTABLE_VAPOR_SETUP_KEY = '__rue_vapor_setup'
export const REPEATABLE_MOUNT_FACTORY_KEY = '__rue_repeatable_mount_factory__'
export const CLEANUP_BUCKET_KEY = '__rue_cleanup_bucket'
export const EFFECT_SCOPE_ID_KEY = '__rue_effect_scope_id'
export const KEEP_ALIVE_HOOK_TARGET_KEY = '__rue_keep_alive_hook_target__'
