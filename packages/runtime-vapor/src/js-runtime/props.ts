import { RUE_STABLE_COMPONENT_HOST_KEY } from '../protocol.js'
...
const removeAttributeUnlessReserved = <HostNode>(
  ...
  if (key !== 'key' && key !== 'children' && key !== RUE_STABLE_COMPONENT_HOST_KEY) {
...
export const patchProps = <HostNode>(
  ...
  for (const key of Object.keys(newProps)) {
    ...
    } else if (key !== 'key' && key !== 'children' && key !== RUE_STABLE_COMPONENT_HOST_KEY) {
