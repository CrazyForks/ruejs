...
//
// `font-data.json` is vendored from vercel/text.js
// (`packages/font/src/google/font-data.json`, MIT License,
// Copyright (c) Vercel, Inc.). Refresh by re-copying that file. Both Text.js
// and text are MIT licensed, so the file is redistributed under the same
// terms.
