...
const ASYNC_HOOKS_STUB_ID = '\0text:async-hooks-stub'
 ...
 */
export function createAsyncHooksStubPlugin(): Plugin {
  return {
    name: 'text:async-hooks-stub',
    enforce: 'pre',
...
export const asyncHooksStubPlugin: Plugin = createAsyncHooksStubPlugin()
