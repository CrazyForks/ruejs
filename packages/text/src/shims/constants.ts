 ...
 * text/constants shim
 *
 * Provides build/runtime phase constants used by text.config.js
...
export enum AdapterOutputType {
  /**
   * `PAGES` represents all the route components that are under `pages/`.
   */
  PAGES = 'PAGES',
  ...
  PAGES_API = 'PAGES_API',
  /**
   * `APP_PAGE` represents all the route components that are under `app/` with the
  ...
  /**
   * `STATIC_FILE` represents a static file (for example /_text/static)
   */
...
export const TEXT_FONT_MANIFEST = 'text-font-manifest'
...
export const RUE_LOADABLE_MANIFEST = 'rue-loadable-manifest.json'
...
export const CONFIG_FILES = [
  ...
  ...(process?.features?.typescript ? ['text.config.mts'] : []),
]
export const BUILD_ID_FILE = 'BUILD_ID'
export const BLOCKED_PAGES = ['/_document', '/_app', '/_error']
export const CLIENT_PUBLIC_FILES_PATH = 'public'
export const CLIENT_STATIC_FILES_PATH = 'static'
export const STRING_LITERAL_DROP_BUNDLE = '__TEXT_DROP_CLIENT_FILE__'
export const TEXT_BUILTIN_DOCUMENT = '__TEXT_BUILTIN_DOCUMENT__'
...
// server/middleware-rue-loadable-manifest.js
export const MIDDLEWARE_RUE_LOADABLE_MANIFEST = 'middleware-rue-loadable-manifest'
...
// text internal client components chunk for layouts
export const APP_CLIENT_INTERNALS = 'app-pages-internals'
// static/runtime/rue-refresh.js
export const CLIENT_STATIC_FILES_RUNTIME_RUE_REFRESH = `rue-refresh`
...
// comparing
// https://textjs.org/docs/api-reference/edge-runtime
// with
...
export const SYSTEM_ENTRYPOINTS = new Set<string>([
  ...
  CLIENT_STATIC_FILES_RUNTIME_RUE_REFRESH,
