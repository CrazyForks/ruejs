/**
 * Shim for text/dist/server/app-render/work-unit-async-storage.external
 * and text/dist/client/components/request-async-storage.external
 *
 ...
 *
 * Used by: @sentry/textjs (runtime resolve for request context injection),
 ...
 * Matches Text.js's WorkUnitStore: packages/text/src/server/app-render/work-unit-async-storage.external.ts
 */
