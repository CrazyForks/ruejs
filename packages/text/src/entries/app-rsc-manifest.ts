...
type BuildAppRscManifestCodeOptions = {
   ...
   * Mirrors Text.js 16's `experimental.globalNotFound` behavior.
...
${interceptEntries.join(',\n')}
    ...
    return `  {
    __buildTimeClassifications: __TEXT_CLASS(${routeIdx}), // evaluated once at module load
    __buildTimeReasons: __classDebug ? __TEXT_CLASS_REASONS(${routeIdx}) : null,
