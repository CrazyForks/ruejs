...
import type { TextLinkPrefetchRoute } from '../client/text-text-data.js'
...
export function generateBrowserEntry(
  ...
  const prefetchRoutes: TextLinkPrefetchRoute[] = routes
...
window.__TEXT_LINK_PREFETCH_ROUTES__ = ${JSON.stringify(prefetchRoutes)};
