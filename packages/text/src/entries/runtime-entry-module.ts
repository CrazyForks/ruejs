...
export function resolveShimRuntimeModule(name: string): string {
  return resolveRuntimeModulePath('shims', name)
}

function resolveRuntimeModulePath(directory: 'client' | 'server' | 'shims', name: string): string {
