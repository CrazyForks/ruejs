 ...
 * available when text loads `text.config.ts` through Vite's `runnerImport`.
 *
 * Text.js's own `text.config.ts` loader (packages/text/src/build/text-config-ts/
 ...
 *     detection — matches the subset Text.js supports
