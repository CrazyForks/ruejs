...
export const NAVIGATION_RUNTIME_SYMBOL_DESCRIPTION = 'text.navigationRuntime'
...
function ensureNavigationRuntimeRscBootstrapForRuntime(
  ...
  if (rscBootstrap === undefined) {
    const textRscBootstrap: NavigationRuntimeRscBootstrap = { rsc: [] }
    runtime.bootstrap.rsc = textRscBootstrap
    return textRscBootstrap
  }
