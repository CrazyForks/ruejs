 ...
 *
 * Tags can flow into HTTP headers (e.g. `x-text-cache-tags` on ISR responses,
 ...
 *
 * Mirrors Text.js's `packages/text/src/server/lib/encode-cache-tag.ts`
 * (introduced in vercel/text.js#93601).
 */
