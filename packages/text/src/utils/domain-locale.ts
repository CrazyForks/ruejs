...
export type DomainLocale = NonNullable<TextI18nConfig['domains']>[number]
 ...
 * same helper can cover Text.js's hostname lookup and preferred-locale lookup.
...
export function getDomainLocaleUrl(
  ...
  if (
    ...
    // logic. This relies on __TEXT_DEFAULT_LOCALE__ matching the current
