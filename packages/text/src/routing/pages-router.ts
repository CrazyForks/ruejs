 ...
 *
 * Follows Text.js Pages Router conventions:
 * - pages/index.tsx -> /
...
function fileToRoute(file: string, pagesDir: string, matcher: ValidFileMatcher): Route | null {
  ...
  // Convert Text.js dynamic segments to URL patterns.
  ...
  for (let i = 0; i < segments.length; i++) {
    ...
    // Matches Text.js PARAMETER_PATTERN.
 ...
 * to Text.js bracket format (e.g., "/posts/[id]", "/docs/[...slug]").
 * Used for __TEXT_DATA__.page which apps expect in Text.js format.
 */
export { patternToTextFormat } from './route-validation.js'
