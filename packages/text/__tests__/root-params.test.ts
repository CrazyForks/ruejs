...
import { getRootParam, runWithRootParamsScope } from '../src/shims/root-params.js'
import {
  runWithRequestContext,
  createRequestContext,
} from '../src/shims/unified-request-context.js'
import { runWithNavigationContext } from '../src/shims/navigation-state.js'
import { getNavigationContext, setNavigationContext } from '../src/shims/navigation.js'

describe('text/root-params shim', () => {
