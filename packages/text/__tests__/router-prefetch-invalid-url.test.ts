 ...
 *
 * Ported from Text.js: test/e2e/app-dir/app-prefetch/prefetching.test.ts
 * https://github.com/vercel/next.js/blob/canary/test/e2e/app-dir/app-prefetch/prefetching.test.ts
 *
 * Text.js validates the href passed to `router.prefetch` via
 ...
 * error". The canonical message thrown by Text.js is:
 *
 *   Cannot prefetch '<href>' because it cannot be converted to a URL.
 *
 * See: packages/text/src/client/components/app-router-utils.ts:27-29.
 *
 * Text previously swallowed unparseable hrefs (caught inside the async
 * prefetch IIFE and reported as `console.error("[text] RSC prefetch setup
...
type Navigation = typeof import('../src/shims/navigation.js')
...
beforeEach(async () => {
  ...
  ;(globalThis as any).window = {
    __TEXT_RSC_PREFETCH_CACHE__: new Map(),
    __TEXT_RSC_PREFETCHED_URLS__: new Set(),
    location: {
...
describe('App Router router.prefetch with an invalid URL', () => {
  // Mirrors Text.js's INVALID_URL fixture:
  // .textjs-ref/test/e2e/app-dir/app-prefetch/app/invalid-url/invalid-url.js
  const INVALID_URL = '///'
