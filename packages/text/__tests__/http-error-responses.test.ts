 ...
 *
 * The 404 body assertion verifies parity with Text.js, which writes
 * "This page could not be found" (no trailing period) as the plain-text
 * 404 body. Sources in .textjs-ref:
 ...
 *   - packages/text/src/pages/_error.tsx L7  (`404: 'This page could not be found'`)
 */
...
} from '../src/server/http-error-responses.js'

describe('notFoundResponse', () => {
  it("uses the Text.js-compatible plain-text body 'This page could not be found'", async () => {
