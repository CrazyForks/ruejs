...
describe('safeJsonStringify', () => {
  ...
  describe('real-world attack payloads', () => {
    it('blocks stored XSS via CMS content in pageProps', () => {
      ...
      const scriptContent = `window.__TEXT_DATA__ = ${result}`
  ...
  describe('output is valid JavaScript', () => {
    it('output can be parsed as a JS expression (simulating script tag eval)', () => {
      ...
      // a <script> tag).
      // oxlint-disable-text-line no-new-func, @typescript-eslint/no-implied-eval
  ...
  // ---------------------------------------------------------------------------
  // Integration: simulating the actual __TEXT_DATA__ embedding pattern
  // ---------------------------------------------------------------------------

  describe('__TEXT_DATA__ embedding simulation', () => {
    it('produces safe output when embedded in a script tag', () => {
      ...
      const scriptContent = `<script>window.__TEXT_DATA__ = ${safeJsonStringify(textData)}</script>`
    ...
    it('produces safe output for navigation runtime RSC bootstrap data', () => {
      ...
      const scriptContent =
        `<script>self[Symbol.for("text.navigationRuntime")]={bootstrap:{routeManifest:null,rsc:` +
    ...
    it('locale globals are safe', () => {
      ...
      const script = `<script>window.__TEXT_LOCALE__=${safeJsonStringify(locale)};window.__TEXT_LOCALES__=${safeJsonStringify(locales)}</script>`
