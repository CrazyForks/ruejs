...
import { resolveAppPageSpecialError } from '../src/server/app-page-execution.js'
import {
  buildAppPageElement,
...
} from '../src/server/app-page-request.js'
...
describe('app page request helpers', () => {
  ...
  // Ported from Text.js: packages/text/src/build/static-paths/app.test.ts
  // https://github.com/vercel/next.js/blob/canary/packages/text/src/build/static-paths/app.test.ts
