...
import { sortFontsVariantValues } from '../../src/build/google-fonts/sort-variants.js'

// Ported from Text.js: packages/font/src/google/sort-fonts-variant-values.test.ts
