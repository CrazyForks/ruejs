...
import { getFontAxes } from '../../src/build/google-fonts/get-axes.js'

// Ported from Text.js: packages/font/src/google/get-font-axes.ts.
// Resolves the `wght` / `ital` / variable-axis values that the URL builder
// then encodes. The metadata-driven path is the whole reason text bundles
...
describe('getFontAxes', () => {
  ...
  it("emits ital ['1'] when only italic style is requested", () => {
    ...
    // becomes ['1'] not ['0','1']. This is the bug text currently has where
