 ...
 * ## Why globalThis?
 *
 * text loads instrumentation.ts via a direct-call ModuleRunner built on the
...
const REGISTER_KEY = '__text_pages_test_registerCalled__'
const ERRORS_KEY = '__text_pages_test_capturedErrors__'
