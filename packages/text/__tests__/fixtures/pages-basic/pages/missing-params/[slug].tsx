...
// Returns an item with no `params` key. Text.js throws
//   "A required parameter (slug) was not provided as a string received undefined"
// (see .textjs-ref/packages/text/src/build/static-paths/pages.ts around line 169).
// text mirrors this by surfacing a per-route error in the prerender result
