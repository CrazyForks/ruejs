...
// Text.js allows getStaticPaths to return `paths` as either:
//   - Array<{ params: { ... } }>
//   - Array<string>
// See https://textjs.org/docs/pages/api-reference/functions/get-static-paths
// and .textjs-ref/packages/text/src/build/static-paths/pages.ts (handles both
