 ...
 * variables are re-initialised. However, globalThis.__TEXT_onRequestErrorHandler__
 ...
 */
const REGISTER_CALLED_KEY = '__text_test_register_called__'
const CAPTURED_ERRORS_KEY = '__text_test_captured_errors__'
 ...
 * via x-text-mw-ctx so middleware only runs once per request.
 *
 ...
 */
const MW_COUNT_KEY = '__text_mw_count__'
const MW_PATHS_KEY = '__text_mw_paths__'
