...
import { ReadonlyURLSearchParams, useSearchParams } from 'text/navigation'

function useTextExternalStore<T>(
...
// Ported from Text.js: test/e2e/app-dir/hooks/app/hooks/use-search-params/instanceof/page.js
...
export default function Page() {
  ...
  const searchParamsClient = useTextExternalStore(
    () => {
      return () => {}
    },
    () => searchParams,
