 ...
 *  2. The HTML contains a __TEXT_RSC_NAV__ script tag with a payload
 ...
 *
 * Without __TEXT_RSC_NAV__, getServerSnapshot returns "/" and empty
 * URLSearchParams regardless of the actual request URL, causing a mismatch
 * between the server-rendered HTML and the client snapshot.
 */
