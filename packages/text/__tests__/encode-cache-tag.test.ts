...
import { encodeCacheTag, encodeCacheTags } from '../src/utils/encode-cache-tag.js'
import { buildPageCacheTags } from '../src/server/implicit-tags.js'
import { buildAppPageCacheTags } from '../src/server/app-page-cache.js'

// Regression: cloudflare/text#1138 — non-ASCII cache tags must be encoded at
// construction so storage, comparison, and any downstream HTTP header
// (`x-text-cache-tags`, Cloudflare cache-tag) see the same ASCII-safe form.
// Mirrors vercel/text.js#93601.
