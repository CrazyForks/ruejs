/**
 * Text.js Compatibility Tests: text/script preload behavior
 *
 * Ported from Text.js: test/e2e/app-dir/app-esm-js/index.test.ts
 ...
 * `strategy="beforeInteractive"`. This follows the App SSR resource-hint
 * behavior that matches Text.js's implementation at
 * .textjs-ref/packages/text/src/client/script.tsx:298-376.
 */
import { describe, it, expect, beforeAll, afterAll } from 'vite-plus/test'
import type { ViteDevServer } from 'vite-plus'
import { APP_FIXTURE_DIR, fetchHtml, startFixtureServer } from '../helpers.js'

describe('Text.js compat: text/script preload (Rue Float)', () => {
