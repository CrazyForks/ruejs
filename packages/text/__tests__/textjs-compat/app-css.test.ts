/**
 * Text.js Compatibility Tests: app-css
 *
 ...
 * - fixtures/app-basic/app/textjs-compat/css-test/
 * - fixtures/app-basic/app/textjs-compat/css-test/global/
 */
...
describe('Text.js compat: app-css', () => {
  ...
  // ── CSS Modules ─────────────────────────────────────────────
  // Text.js: CSS module class names should be scoped in SSR
  ...
  it('CSS module class name is applied in SSR HTML', async () => {
    const { html } = await fetchHtml(baseUrl, '/textjs-compat/css-test')
  ...
  // ── Global CSS ──────────────────────────────────────────────
  // Text.js: global CSS class names should be preserved in SSR

  it('global CSS page renders content', async () => {
    const { html } = await fetchHtml(baseUrl, '/textjs-compat/css-test/global')
