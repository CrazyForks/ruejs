 ...
 *
 * Fixture: app/textjs-compat/layout-params-notfound/[slug]/
 *
...
test.describe('layout params in fallback render (renderHTTPAccessFallbackPage)', () => {
  ...
  test('valid slug: layout renders with correct data-slug', async ({ page }) => {
    await page.goto(`${BASE}/textjs-compat/layout-params-notfound/hello`)
    ...
    await expect(page.locator('#layout-params-notfound-page')).toHaveText('Page content for: hello')
  })
  ...
  test('invalid slug: layout wrapper has correct data-slug in not-found render', async ({
    ...
    await page.goto(`${BASE}/textjs-compat/layout-params-notfound/bad-slug`)
  ...
  test('another invalid slug: wrapper has correct data-slug', async ({ page }) => {
    await page.goto(`${BASE}/textjs-compat/layout-params-notfound/nope`)
