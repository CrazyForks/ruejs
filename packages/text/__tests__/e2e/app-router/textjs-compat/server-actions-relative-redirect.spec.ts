...
const ROUTE = '/textjs-compat/server-actions-relative-redirect'

test.describe('Text.js compat: server-actions-relative-redirect', () => {
  // Ported from Text.js: test/e2e/app-dir/server-actions-relative-redirect/server-actions-relative-redirect.test.ts
