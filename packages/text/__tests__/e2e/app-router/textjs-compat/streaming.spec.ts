/**
 * Text.js Compat E2E: streaming / loading.tsx
...
test.describe('Text.js compat: streaming / loading.tsx (browser)', () => {
  // Streaming page renders fully
  test('streaming page renders fully in browser', async ({ page }) => {
    await page.goto(`${BASE}/textjs-compat/streaming-test`)
  ...
  test('nested streaming resolves all boundaries', async ({ page }) => {
    await page.goto(`${BASE}/textjs-compat/streaming-test/nested`)
