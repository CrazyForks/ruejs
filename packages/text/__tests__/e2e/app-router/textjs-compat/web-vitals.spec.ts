/**
 * Ported from Text.js: test/e2e/app-dir/app/useReportWebVitals.test.ts
...
test.describe('Text.js compat: useReportWebVitals', () => {
  test('reports browser web vitals from text/web-vitals', async ({ page }) => {
    ...
    await page.goto(`${BASE}/textjs-compat/report-web-vitals`)
