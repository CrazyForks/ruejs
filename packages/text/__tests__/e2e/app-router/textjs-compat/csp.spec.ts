...
test.describe('Text.js compat: CSP nonce (browser)', () => {
  ...
  test('text/dynamic preloads carry the middleware nonce and hydrate cleanly', async ({
    page,
    consoleErrors,
  }) => {
    const response = await page.goto(`${BASE}/textjs-compat/dynamic?csp-nonce=1`)
