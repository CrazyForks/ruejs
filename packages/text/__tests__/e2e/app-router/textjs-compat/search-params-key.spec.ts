/**
 * Text.js Compat E2E: search-params-rue-key
 *
 * Ported from: https://github.com/vercel/next.js/blob/canary/test/e2e/app-dir/search-params-rue-key/layout-params.test.ts
 *
...
test.describe('Text.js compat: search-params-rue-key (browser)', () => {
  // Text.js: 'should keep the Rue router instance the same when changing the search params'
  test('component state persists across search param changes via router.push', async ({ page }) => {
    await page.goto(`${BASE}/textjs-compat/search-params-key`)
