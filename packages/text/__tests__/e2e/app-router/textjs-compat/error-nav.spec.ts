/**
 * Text.js Compat E2E: error-boundary-navigation
...
test.describe('Text.js compat: error-boundary-navigation (browser)', () => {
  test('can navigate away from error page', async ({ page }) => {
    await page.goto(`${BASE}/textjs-compat/error-nav`)
    ...
    // The dev overlay opens on a caught error and would intercept the text
  ...
  test('error boundary reset button works', async ({ page }) => {
    await page.goto(`${BASE}/textjs-compat/error-nav/trigger-error`)
  ...
  test('can navigate away from not-found page', async ({ page }) => {
    await page.goto(`${BASE}/textjs-compat/error-nav/trigger-notfound`)
