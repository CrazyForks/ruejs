 ...
 *   - The catch block logs "[text] RSC navigation error: ..." and hard-navs
 ...
 *
 * Ported behavior from Text.js fetch-server-response.ts:211:
...
function isRscStreamParseError(msg: string): boolean {
  const hasRscContext = msg.includes('RSC') || msg.includes('text')
  return (
