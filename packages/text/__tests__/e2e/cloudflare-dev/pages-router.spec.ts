 ...
 * where virtual:text-server-entry → renderPage / handleApiRoute run inside
 * miniflare with the full Workers runtime.
 *
 * ## The fix
 *
 * When hasCloudflarePlugin is true, the connect handler calls text() after
 ...
 *   - app/page.tsx     → "text on Cloudflare Workers"  (App Router, Worker)
 *
