...
} from '../src/server/app-request-context.js'
import { setHeadersContext, getHeadersContext } from '../src/shims/headers.js'
import { getNavigationContext } from '../src/shims/navigation.js'
import { getRootParam } from '../src/shims/root-params.js'

describe('clearAppRequestContext', () => {
  afterEach(() => {
    // Ensure clean state for text test.
    clearAppRequestContext()
  })
