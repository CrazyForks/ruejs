...
import {
  ...
  routePattern,
  routePatternParts,
} from '../src/routing/route-pattern.js'

describe('route pattern helpers', () => {
  it('normalizes app route segments into text pattern parts', () => {
...
// Helper extracted from packages/text/src/build/prerender.ts,
// packages/text/src/server/pages-page-data.ts, and
// packages/text/src/server/dev-server.ts (originally added in PR #1227).
// Mirrors .textjs-ref/packages/text/src/build/static-paths/pages.ts.
