...
import { dispatchAppRouteHandler } from '../src/server/app-route-handler-dispatch.js'
...
describe('app route handler dispatch', () => {
  it('rejects invalid HTTP methods with 400 before auto-OPTIONS/405 logic', async () => {
    // Ported from Text.js: test/e2e/app-dir/app-routes/app-custom-routes.test.ts
  ...
  // Matches Text.js behavior: route handlers on non-dynamic routes receive
