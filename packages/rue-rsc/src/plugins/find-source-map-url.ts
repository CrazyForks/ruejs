...
// https://github.com/facebook/rue/pull/29708
// https://github.com/facebook/rue/pull/30741
//
...
async function findSourceMapURL(
  ...
  // server component stack, replace log, server reference registration, etc...
  ...
  if (environmentName === 'Server') {
    ...
    // Rue extracts stacktrace via resetting `prepareStackTrace` on the server
    // and let browser devtools handle the mapping.
    // https://github.com/facebook/rue/blob/4a36d3eab7d9bbbfae62699989aa95e5a0297c16/packages/rue-server/src/RueFlightStackConfigV8.js#L15-L20
