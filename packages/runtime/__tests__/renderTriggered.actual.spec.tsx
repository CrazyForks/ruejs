...
import OnRenderTriggered from '../../../app/pages/examples/OnRenderTriggered'
...
describe('OnRenderTriggered actual page', () => {
  it('switches between preview/code and records signal-triggered render events', async () => {
    const container = mountContainer()
    resetActiveRuntime()
    render(<OnRenderTriggered />, container)

    await waitForContent(() => {
      expect(container.textContent).toContain('onRenderTriggered 调试示例')
      expect(container.textContent).toContain('Triggered events')
      expect(container.textContent).toContain('与左侧预览交互后')
    })
