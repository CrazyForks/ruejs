...
- 单元测试：[packages/rue-design/src/components/rating/__tests__/Rating.spec.tsx](../../packages/rue-design/src/components/rating/__tests__/Rating.spec.tsx)
- Demo 页面：[app/pages/design/Rating.tsx](../../app/pages/design/Rating.tsx)
- Actual 测试：[packages/runtime/__tests__/rating.actual.spec.tsx](../../packages/runtime/__tests__/rating.actual.spec.tsx)
- 路由：`/design/rating`
