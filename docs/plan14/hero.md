...
- 单元测试：[packages/rue-design/src/components/hero/__tests__/Hero.spec.tsx](../../packages/rue-design/src/components/hero/__tests__/Hero.spec.tsx)
- Demo 页面：[app/pages/design/Hero.tsx](../../app/pages/design/Hero.tsx)
- Actual 测试：[packages/runtime/__tests__/hero.actual.spec.tsx](../../packages/runtime/__tests__/hero.actual.spec.tsx)
- 路由：`/design/hero`
- 组件模式：compound 结构封装
