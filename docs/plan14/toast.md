...
- 单元测试：[packages/rue-design/src/components/toast/__tests__/Toast.spec.tsx](../../packages/rue-design/src/components/toast/__tests__/Toast.spec.tsx)
- Demo 页面：[app/pages/design/Toast.tsx](../../app/pages/design/Toast.tsx)
- Actual 测试：[packages/runtime/__tests__/toast.actual.spec.tsx](../../packages/runtime/__tests__/toast.actual.spec.tsx)
- 路由：`/design/toast`
- 组件模式：容器类封装
