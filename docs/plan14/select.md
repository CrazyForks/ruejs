...
- 单元测试：[packages/rue-design/src/components/select/__tests__/Select.spec.tsx](../../packages/rue-design/src/components/select/__tests__/Select.spec.tsx)
- Demo 页面：[app/pages/design/Select.tsx](../../app/pages/design/Select.tsx)
- Actual 测试：[packages/runtime/__tests__/select.actual.spec.tsx](../../packages/runtime/__tests__/select.actual.spec.tsx)
- 路由：`/design/select`
- 组件模式：原生 select 薄封装
