...
- 单元测试：[packages/rue-design/src/components/skeleton/__tests__/Skeleton.spec.tsx](../../packages/rue-design/src/components/skeleton/__tests__/Skeleton.spec.tsx)
- Demo 页面：[app/pages/design/Skeleton.tsx](../../app/pages/design/Skeleton.tsx)
- Actual 测试：[packages/runtime/__tests__/skeleton.actual.spec.tsx](../../packages/runtime/__tests__/skeleton.actual.spec.tsx)
- 路由：`/design/skeleton`
- 组件模式：视觉类薄封装
