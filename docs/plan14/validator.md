...
- 单元测试：[packages/rue-design/src/components/validator/__tests__/Validator.spec.tsx](../../packages/rue-design/src/components/validator/__tests__/Validator.spec.tsx)
- Demo 页面：[app/pages/design/Validator.tsx](../../app/pages/design/Validator.tsx)
- Actual 测试：[packages/runtime/__tests__/validator.actual.spec.tsx](../../packages/runtime/__tests__/validator.actual.spec.tsx)
- 路由：`/design/validator`
- 组件模式：compound 辅助封装
