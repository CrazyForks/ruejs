...
- 单元测试：[packages/rue-design/src/components/indicator/__tests__/Indicator.spec.tsx](../../packages/rue-design/src/components/indicator/__tests__/Indicator.spec.tsx)
- Demo 页面：[app/pages/design/Indicator.tsx](../../app/pages/design/Indicator.tsx)
- Actual 测试：[packages/runtime/__tests__/indicator.actual.spec.tsx](../../packages/runtime/__tests__/indicator.actual.spec.tsx)
- 路由：`/design/indicator`
- 组件模式：compound 结构封装
