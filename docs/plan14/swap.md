...
- 单元测试：[packages/rue-design/src/components/swap/__tests__/Swap.spec.tsx](../../packages/rue-design/src/components/swap/__tests__/Swap.spec.tsx)
- Demo 页面：[app/pages/design/Swap.tsx](../../app/pages/design/Swap.tsx)
- Actual 测试：[packages/runtime/__tests__/swap.actual.spec.tsx](../../packages/runtime/__tests__/swap.actual.spec.tsx)
- 路由：`/design/swap`
- 组件模式：compound 结构封装
