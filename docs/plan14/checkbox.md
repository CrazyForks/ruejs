...
- 单元测试：[packages/rue-design/src/components/checkbox/__tests__/Checkbox.spec.tsx](../../packages/rue-design/src/components/checkbox/__tests__/Checkbox.spec.tsx)
- Demo 页面：[app/pages/design/Checkbox.tsx](../../app/pages/design/Checkbox.tsx)
- Actual 测试：[packages/runtime/__tests__/checkbox.actual.spec.tsx](../../packages/runtime/__tests__/checkbox.actual.spec.tsx)
- 路由：`/design/checkbox`
- 组件模式：原生 input 薄封装
